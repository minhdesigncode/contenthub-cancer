// ============================================================
// MEDINAV AI CHATBOT — Paste this INSIDE the DOMContentLoaded
// callback in script.js, right before the closing `});`
// ============================================================
...
<div id="chat-fab" title="Chat với MediNav AI">
...
function addProgramCards(filename) {
  ...
  // Step 2: cards container (no avatar, full-width)
